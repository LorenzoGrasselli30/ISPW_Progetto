...
public class ProviderDAODemo implements ProviderDAO{
	...
	private void initializeProviderDemo() {
		...
		provider1.addActivity("Roma: tour guidato del Colosseo", "Visita il Colosseo, il più grande anfiteatro del mondo romano", 
				1, false, ActivityType.CULTURE, true, false, true, 340, 4.8);
		provider1.addActivity("Roma: biglietto d'ingresso per Castel Sant'Angelo", "Risparmia tempo durante il tuo viaggio a Roma con questo biglietto d'ingresso a Castel Sant'Angelo", 
				2, false, ActivityType.CULTURE, true, true, true, 200, 4.5);
		provider1.addActivity("Roma: tour privato del Foro Romano e del Palatino", "Esplora il cuore dell'antica Roma con un tour del Foro Romano e del Palatino con una guida autorizzata", 
		...
		provider2.addActivity("Parigi: laboratorio di pasticceria francese", "impara a preparare madeleine, macaron, financier e una deliziosa cioccolata calda", 
		...
		provider3.addActivity("Madrid: Biglietto d'ingresso al Palazzo Reale", "Goditi un viaggio nella storia della Spagna e della sua monarchia grazie a questo biglietto d'ingresso con accesso rapido al Palazzo Reale di Madrid", 
				150, true, ActivityType.CULTURE, true, true, true, 130, 4.2);
		provider3.addActivity("Madrid: biglietto per lo Zoo Aquarium", "Scopri animali, creature del mare e piante provenienti da tutto il mondo", 
